  ...
  const benefits = [
    {
      ...
      desc: "Manage calls, campaigns, contacts, and billing from a single dashboard.",
    },
    {
      num: "02",
      icon: Phone,
      title: "Professional Business Communication",
      desc: "Give your business a professional number, extensions, and IVR.",
    },
    {
      num: "03",
      icon: Users,
      title: "Easy for Non-Technical Teams",
      desc: "Simple controls designed for business owners and teams.",
    },
    {
      num: "04",
      icon: Zap,
      title: "Flexible for Growing Businesses",
      desc: "Start with what you need and scale as your team grows.",
    },
    {
      num: "05",
      icon: BarChart3,
      title: "Real-Time Visibility",
      desc: "See call activity, campaigns, and usage clearly.",
    },
    {
      num: "06",
      icon: Settings,
      title: "Managed Setup & Support",
      desc: "Our team assists with supported setup and configuration.",
    },
    {
      num: "07",
      icon: Wallet,
      title: "Clear Pricing & Billing",
      desc: "Transparent monthly fees and usage visibility.",
    },
    {
      num: "08",
      icon: ShieldCheck,
      title: "Business-Focused Features",
      desc: "Practical tools built for customer communication.",
    },
  ];
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 mb-32">
          <div className="lg:col-span-4 lg:sticky lg:top-24 lg:self-start">
            ...
            <p className="text-slate-500 mt-5 text-sm leading-relaxed">
              Practical, business-focused tools designed to simplify your
              communication workflow — built for Bangladesh businesses.
            </p>
          </div>
